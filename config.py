...
def parse_args():
    parser = argparse.ArgumentParser(description="Example for training script.")
    # Updated default model for SDXL
    ...
    parser.add_argument("--train_data_dir", type=str, default="datasets")
    parser.add_argument("--output_dir", type=str, default="exps/exp_person")
    # Updated resolution for SDXL (1024x1024 is native for SDXL)
    parser.add_argument("--resolution",type=int,default=1024)
    parser.add_argument("--model_type",type=str,default="MLP")

    #training
    parser.add_argument("--train_batch_size", type=int, default=4, help="Batch size (per device) for the training dataloader. Reduced for SDXL due to memory requirements")
    parser.add_argument("--gradient_accumulation_steps",type=int,default=2)  # Increased for SDXL
    parser.add_argument("--num_train_epochs", type=int, default=20)
    parser.add_argument("--select", type=str, default="random")

    parser.add_argument("--learning_rate",type=float,default=5e-2,help="Initial learning rate (after the potential warmup period) to use. Adjusted for SDXL",)
    ...
    parser.add_argument('--log_every_steps', type=int, default=3000)
    ...
    parser.add_argument('--refiner_model_name_or_path', type=str, default='stabilityai/stable-diffusion-xl-refiner-1.0')
    parser.add_argument('--high_noise_frac', type=float, default=0.8, help="Fraction of noise steps for base model when using refiner")
